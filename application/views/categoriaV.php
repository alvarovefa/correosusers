...
<html>
  ...
  $(document).ready( function () {
    ...
    function edit_book(id)
    {
      ...
      $.ajax({
        url : "<?php echo site_url('/CategoriaC/ajax_edit/')?>/" +id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {

            $('[name="id"]').val(data.id_categoria);
    ...
    function save()
    {
      ...
      if(save_method == 'add')
      {
          url = "<?php echo site_url('/CategoriaC/book_add')?>";
      }
      else
      {
        url = "<?php echo site_url('/CategoriaC/book_update')?>";
      }
    ...
    function delete_book(id)
    {
      if(confirm('¿Estás seguro de hacer esto?'))
      {
        // ajax delete data from database
          $.ajax({
            url : "<?php echo site_url('/CategoriaC/book_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title">Categoría</h3>
      </div>
